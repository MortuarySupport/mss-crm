...
function VehicleLog({user,onBack}){
  ...
  function printWeeklyReport(){
    const d=new Date(reportWeek+"T00:00:00");const day=d.getDay();const diff=day===0?-6:1-day;const weekStart=new Date(d);weekStart.setDate(d.getDate()+diff);const weekEnd=new Date(weekStart);weekEnd.setDate(weekStart.getDate()+6);
