    ...
    <div className="w-full px-3 py-4" style={{maxWidth:"100%",boxSizing:"border-box"}}>
      ...
      <div className={s.card}>
        ...
        {[
          ...
          {cat:"Cosmetics",items:[{code:"DRS",label:"Dressing/Make Up"},{code:"FP",label:"Finger Prints/Hair Locks"},{code:"PR",label:"Pacemaker Removal",onExtra:()=>setShowPacemakerCert(true)}]},
