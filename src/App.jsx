  ...
  return(
    ...
    <div>
      <div className="grid grid-cols-3 sm:grid-cols-5 gap-1 mb-3">
        ...
        <button onClick={()=>updStatus("mccd",si.mccd===undefined?null:undefined)} className={"py-2 rounded-xl border-2 text-xs font-black uppercase transition "+(si.mccd==="proceed"?green:si.mccd==="infectious"?red:alert36&&si.mccd===undefined?red:neutral)}>{si.mccd==="proceed"?"MCCD ✓":si.mccd==="infectious"?"MCCD ⚠":"MCCD | BO"}</button>
